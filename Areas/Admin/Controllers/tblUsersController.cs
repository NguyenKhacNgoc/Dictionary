...
namespace Dictionary.Areas.Admin.Controllers
{
    public class tblUsersController : Controller
    {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.sRole = new SelectList(db.tblUsers.Select(u => u.sRole).Distinct().ToList());
            return View(tblUser);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,sEmail,sPasswordHash,sSalt,sRole")] tblUser tblUser)
        {
            if (ModelState.IsValid)
            {
